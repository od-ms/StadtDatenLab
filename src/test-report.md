...
# Text mit eingebetteten Diagrammen


<br />

<div class="tip" label="Test">Dieser Text enthält Diagramme und hat außerdem ein klickbares Inhaltsverzeichnis an der rechten Bildschirmseite.</div>
